...
>
> **Stable (`v1.0.0`).** The public surface documented here is frozen until
> `2.0`. Every public type is asserted `Send + Sync + 'static` at compile time,
> and every algorithm is stress-tested under contention.
